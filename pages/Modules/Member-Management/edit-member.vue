      ...
      <div id="layoutSidenav_content">
        ...
        <main>
          <div class="container-fluid px-4">
            ...
            <div class="row">
              <div class="card mb-4">
                <div class="card-header icon-title"><a href="#"><i class="fa fa-users"></i></a><h4>Doctor Profile</h4></div>
                <div class="card-body">
                  <nav>
                    ...
                    <div class="content-subtab">
                      <form id="staffForm" class="g-3 mt-3">
                        ...
                        <div class="form-foter mt-3">
                          <a href="/app/modules/doctor-management/doctor-record" class="btn btn-primary btn-text"><i class="fa fa-arrow-alt-to-left"></i> Back</a>
        ...
        this.$swal.fire({title: 'Update this record?',showCancelButton: true,confirmButtonText: 'Yes',cancelButtonText: 'Cancel',reverseButtons: true}
          ...
          if ((this.name && this.nricno && this.contact && this.email && this.roleId)) {
            ...
            if (response.data.code == 200 || response.data.code == "200") {
              ...
              this.$router.push("/Modules/doctor-Management/doctor-record");
